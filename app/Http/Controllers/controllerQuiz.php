...
class controllerQuiz extends Controller
{
    ...
    public function __construct(){
        ...
        $this->perguntas['pergunta6'] = 'D';
        $this->perguntas['pergunta7'] = 'A';
        $this->perguntas['pergunta8'] = 'D';
    ...
    public function dadosPagina10(Request $request){
        ...
        if($acertos == 10)
            $dados['mensagem'] = "Excelente!! Você acertou todas!! Parabéns super fã!!!";
        else if($acertos > 7)
            ...
            $dados['mensagem'] = "Precisa estudar mais sobre a banda. Você acertou " . $acertos . "de 10.";
